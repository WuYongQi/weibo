	...
	$.fn.SinaEmotion = function(target){
		...
		$(this).click(function(event){
			...
			if($('#emotions .categorys')[0]){
				...
				// $('#emotions').css({top: '226px', left: eLeft,padding: '8px'});
				$('#emotions').toggle();
				return;
			}
			...
			$('#emotions').html('<span class="S_bg2_br"></span><div style="float:right"><a href="javascript:void(0);" id="prev">&laquo;</a><a href="javascript:void(0);" id="next">&raquo;</a></div><div class="categorys"></div><div class="container"></div><div class="page"></div>');
